...
class Translator:  # TODO: your work for Projects 7 and 8 starts here
    path: Path
    file_name = "???"
    line_diffenertial = 0
    TYPE_TO_FUNCTION: dict[
    ...
    def push_function(self, instruction: str, fl: str) -> str:
    ...
    def pop_function(self, instruction: str, file_n: str) -> str:
        inst = instruction.split()
        segment = inst[1]
        addr = inst[2]
        asm_code = ""
